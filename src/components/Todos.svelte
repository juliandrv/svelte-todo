<script lang="ts">
  ...
  import FiltersTodo from './FiltersTodo.svelte';
  ...
  const setFilter = async (newFilter: FiltersType): Promise<void> => {
    filtering = true;
    await tick();
  ...
  <section class="todos">
    ...
    {#if todosAmount}
      ...
      <div class="actions">
        ...
        <FiltersTodo {selectedFilter} {setFilter} />
